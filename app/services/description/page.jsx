  ...
  return (
    <article className='bg-white rounded-lg p-2 lg:p-6 w-full'>
      ...
      <div className='mt-6'>
        ...
        <p className='indent-5 lg:text-xl lg:leading-8'>
          - Договор на оказании услуг по размещению информации в Государственной информационной системе Жилищно-коммунального хозяйства (ГИС ЖКХ) от 01.02.2023 г. (далее по тексту – договор) – <Link className="text-sky-700" href='/public/files/dogovor-gis.pdf'>ознакомиться</Link>.
        </p>
        <p className='indent-5 lg:text-xl lg:leading-8'>
          - Дополнительные соглашения к договору – отсутствуют.
        </p>
        <p className='indent-5 lg:text-xl lg:leading-8'>
        Чтобы заключить договор на размещение информации необходимо заполнить и направить в наш адрес заявления по следующей форме – <Link className="text-sky-700" href='/public/files/zaevleniy-gis.docx'>скачать образец заявления</Link>.
        </p>
      </div>
      <hr />
      <p className='indent-5 lg:text-xl lg:leading-8'>
